...
KeyInfo = {
 * int => any ; Positive integers are RFU, negative integers may be used for proprietary use
}
...
DeviceSigned = {
 ...
 “deviceAuth”: DeviceAuth ; Device authentication for mdoc authentication (i.e. presentation)
}
...
DeviceSignature = COSE_Sign1 ; Untagged COSE_Sign1 signature of detached DeviceAuthenticationBytes
...
OpenID4VPHandoverInfo = [
 ...
 jwkThumbprint: bstr, ; JWK SHA-256 Thumbprint (RFC 7638) of the Verifier’s public key used for encryption
