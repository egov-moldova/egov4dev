...
!!! note "Obtaining credentials"
    ...
    MSign accepts client certificates generated by Certification Authority of the Information Technology and Cyber Security Service (<https://stisc.gov.md>), by requesting a certificate for authentication.
