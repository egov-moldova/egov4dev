...
7. The beneficiary performs functional tests according to the technical guide (in accordance with Chapter 9 of the Integration Guide)
...
10. The beneficiary grants access to the test environment of their system for performing the necessary tests.
11. The beneficiary receives a notification confirming the completion of the integration. 
